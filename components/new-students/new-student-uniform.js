    ...
    <>
      <section className="p-5 bg-asb-accent">
        ...
        <div className="text-center">
          ...
          <div className="d-flex justify-content-center g-1">
            <Zoom>
              <Image
                className="p-2"
          ...
          {/* <Button variant="light" onClick={() => setBoys(true)}>
            <Image
              className="p-0"
              src="/images/uniform/uniform-sketch-boys.jpg"
              alt="uniform"
          ...
          <Button variant="light" onClick={() => setGirls(true)}>
            <Image
              className="p-0"
              src="/images/uniform/uniform-sketch-girls.jpg"
              alt="uniform"
