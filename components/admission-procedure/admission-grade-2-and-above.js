...
export default function AdmissionGrade2andAbove() {
  return (
    <>
      <Row className="py-5 bg-asb-accent">
        <Col>
          {/* <div className="mx-1 mx-lg-5 mt-5 mb-1 py-5 py-lg-5 px-1 px-lg-5">  */}
          <div className="step-container">
            <p className="fw-bold mb-4">
              Before applying for admission, please make sure that ...
            </p>
            <ul className="admission-li">
              <li className="mb-3">
                <Icon
              ...
              <li className="mb-3">
                <Icon
                  ...
                  className="me-3"
                />
                The child has studied in CBSE affiliated schools.
              </li>
              <li className="mb-3">
                <Icon
                  icon="prime:check-circle"
                  ...
                  className="me-3"
                />
                Grades 2 to 9: The child&apos;s academic performance is
                excellent (aggregate above 75%).
              </li>
              <li className="mb-3">
                <Icon
                  icon="prime:check-circle"
                  ...
                  className="me-3"
                />
                Grade 11, Science stream: The child has an aggregate above 75%.
                <p className="my-0 ms-5">
                  Grade 11, Commerce stream: The child has an aggregate above
                  70%.
                </p>
                <p className="my-0 ms-5">
                  Grade 11, Humanities stream: The child has an aggregate above
                  60%.
                </p>
              </li>
            </ul>
          ...
          <div className="mx-1 mx-lg-5 mt-5 mb-3 py-5 py-lg-5 px-3 px-lg-5 bg-light border border-asb-main">
            <p>
          ...
          <div className="step-container">
            ...
            <div className=" bg-white border border-asb-main">
              <Row className="my-3">
            ...
            <Row className="my-5">
              <Col md={3} className="d-flex justify-content-center">
                <a href="http://portal.asianschool.bh/ASBDC/" target="_blank" rel="noopener noreferrer">
          ...
          <div className="step-container bg-white border border-asb-main">
            <p>
              <strong>
