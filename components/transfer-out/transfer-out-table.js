...
export default function TransferOutTable() {
  ...
  [
    ...
    },
    {
      Header: "Download",
      accessor: "url",  
      Cell: ({value})=> {return <Link href={value}><a target="_blank"><Icon icon="bi:download" width={15}/> </a></Link>} 
    }
  ], []);
  ...
  return (
    ...
    <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} />
      ...
      <Table striped hover {...getTableProps()} className="table table-sm table-responsive align-middle text-center mx-auto">
